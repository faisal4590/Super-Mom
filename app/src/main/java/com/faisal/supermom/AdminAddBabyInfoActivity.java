...
public class AdminAddBabyInfoActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(AdminAddBabyInfoActivity.this,
                                    "You have been signed out.",
                                    Toast.LENGTH_LONG)
                                    .show();

                            // Close activity
                            startActivity(new Intent(AdminAddBabyInfoActivity.this,LoginActivity.class));
        ...
        if (item.getItemId() == R.id.addDoctorInfoMenuNewID){
            startActivity(new Intent(AdminAddBabyInfoActivity.this,AdminAddDoctorActivityNew.class));
        }
